...
class BlockVideoOembedModel extends window.HTMLDivElement {
  constructor (...args) {
...
window.customElements.define('flynt-block-video-oembed-model', BlockVideoOembedModel, { extends: 'div' })
